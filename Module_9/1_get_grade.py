...
# Перша - get_grade, приймає ключ в оцінці ECTS і повертає відповідну п'ятибальну оцінку 
# (перший стовпчик таблиці). Друга - get_description, теж приймає ключ у оцінки ECTS, 
# але повертає пояснення оцінки у текстовому форматі (останній стовпчик таблиці). 
...
# Якщо параметр за значенням не співпав із заданими, 
