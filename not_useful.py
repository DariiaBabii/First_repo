...
# # Отримуємо значення по ключу 'name' (в цьому випадку рядок)
# value = my_dict['name']

# # Тепер ми можемо пройтися по символах рядка 'value'
# for char in value:
#     print(f"Index: {index}, Value: {char}")  # Виводить кожен символ рядка на окремому рядку
