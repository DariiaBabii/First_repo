...
# Зберігати дані словника employee_residence у файл, 
# де кожен новий рядок — це ключ значення через пробіл як "Michael Canada"
...
def create_backup(path, file_name, employee_residence):
    ...
    # Записуємо дані про співробітників у файл
